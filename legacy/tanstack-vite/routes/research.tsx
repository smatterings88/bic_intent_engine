  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <Link
          to="/where-deals-break"
          className="block mb-12 border border-border bg-secondary/40 px-6 py-6 hover:bg-secondary transition-colors"
        >
          ...
          <span className="mt-4 inline-block text-sm text-primary">Read the report →</span>
        </Link>
